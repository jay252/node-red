...
var RED = (function() {
    ...
    function buildMainMenu() {
        ...
        */
        ...
        //$('<li><a id="red-ui-header-button-sidemenu" class="button" href="#">Menu</a></li>').prependTo(".red-ui-header-toolbar")

        $('<li><span class="red-ui-deploy-button-group button-group">'+
            '<a id="red-ui-header-button-sidemenu" class="red-ui-deploy-button" href="#">'+
