...
RED.deploy = (function() {
    ...
    function init(options) {
        options = options || {"type":"simple","label":"Save","icon":null};
        ...
        if (type == "default") {
            ...
            $('<li><span class="red-ui-deploy-button-group button-group">'+
            '<a id="red-ui-header-button-restart" class="red-ui-deploy-button" href="#">'+
              '<span class="red-ui-deploy-button-content">'+
                '<span>Restart</span>'+
              '</span>'+
              '<span class="red-ui-deploy-button-spinner hide">'+
        ...
        $('#red-ui-header-button-restart').on("click", function(event) {
