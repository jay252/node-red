...
$directus-background: #f0f4f9;
$directus-background-hover: #e4eaf1;

$shadow: rgba(0, 0, 0, 0.2);

// Main body text
$primary-text-color:rgb(23, 41, 64);//#0f0;
...
// Heading text
$header-text-color: rgb(23, 41, 64);//#444;//#f00;
...
$list-item-background-selected: #e4eaf1; // #fff1e5;
...
$deploy-button-color: #333;//#eee;
$deploy-button-color-active: #ccc;
$deploy-button-color-disabled: #ccc;
$deploy-button-background: #e4eaf1; //#8C101C;
$deploy-button-background-hover: #c8dcf3;
$deploy-button-background-active: #4C0A17;
$deploy-button-background-disabled: #bbb;
$deploy-button-background-disabled-hover: #555;


$header-background: #4396BE;
...
$tourGuide-border: #4396be;
$tourGuide-heading-color: #4396be;
