export default {
    ...
    steps: [
        {
            titleImage: "fa fa-map-o",
            title: {
                "en-US": "Welcome to Sandcherry Integrator",
                "ja": "Node-RED 2.1へようこそ!"
        },
            description: {
                "en-US": "Let's take a tour.",
        ...
        },
        {
            ...
            direction: "left",
            description: {
                "en-US": "<p>The main menu has an 'Edit' section. This includes all of the familar options, like cut/paste and undo/redo.</p>" +
                         "<p>The menu displays keyboard shortcuts for the options.</p>",
        ...
        },
        {
            ...
            direction: "left",
            description: {
                "en-US": "<p>The 'Arrange' section of the menu provides options to help arrange your steps. You can align them to a common edge, spread them out evenly or change their order.</p>",
        ...
        },
        {
            ...
            description: {
                "en-US": '<p>Tabs can be hidden by clicking their <i class="fa fa-times"></i> icon.</p><p>The Info Sidebar will still list all of your tabs, and tell you which ones are currently hidden.',
        ...
        },
        {
            ...
            description: {
                "en-US": "<p>The tab menu also provides lots of options for your tabs.</p>",
