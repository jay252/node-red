...
(function() {
    ...
    RED.nodes.registerType('debug',{
        ...
        label: function() {
            ...
            } else if (this.targetType === "msg"){
                return (this.name || "msg." + ((!this.complete || this.complete === "false") ? "payload" : this.complete)) + suffix;
            } else if (this.targetType === "flow"){
                return (this.name || "flow." + ((!this.complete || this.complete === "false") ? "payload" : this.complete)) + suffix;
            }
        },
        paletteLabel: "Log",
        labelStyle: function() {
        ...
        oneditprepare: function() {
            ...
            $("#node-input-typed-complete").typedInput({
                default: "msg",
                types:['msg','flow', fullType, "jsonata"],
            ...
            if (this.targetType === "jsonata") {
                ...
                $("#node-input-typed-complete").typedInput('type','flow');
                $("#node-input-typed-complete").typedInput('value',this.complete);
            }
